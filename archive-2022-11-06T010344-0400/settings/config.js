module.exports = {
  TOKEN:
    process.env.TOKEN ||
    "OTg3OTU3Mzg2ODgwODg4ODgz.GchfqA.7RPx19KZQe5txRN9OmWh53PgyHFIwU5K5hi7ac",
  PREFIX: process.env.PREFIX || "+",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "knifecodez",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  // others
  guildID: process.env.guildID || "1020646734164152380", // for slash command
  mongodb : process.env.mongodb || "mongodb+srv://knife: discordbot0001@cluster0.nng2hfx.mongodb.net/?retryWrites=true&w=majority",
  filters: {
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://invite.soul07.ml`,
    VoteURL: process.env.VoteURL || `https://invite.soul07.ml`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true
